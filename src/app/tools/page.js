...
export const metadata = {
  title: "Tools · Trianglehead",
  description: "Interactive music tools for developing musical fluency.",
};
    ...
    <>
      ...
      <div style={{ padding: "28px 28px 0" }}>
        ...
        <p style={{ fontFamily: "Georgia, serif", fontSize: 13, color: "#555", lineHeight: 1.65, margin: "0 0 28px", borderBottom: "1.5px solid #DDD9CE", paddingBottom: 20 }}>
          Tools for developing musical fluency — pitch, rhythm, and everything in between. More coming soon.
        </p>
      </div>
