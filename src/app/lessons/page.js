            ...
            <div style={{ padding: "20px 20px 24px" }}>
              ...
              <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
                ...
                <a
                  ...
                  className="btn"
                  style={{ fontFamily: "var(--font-space-mono), monospace", fontSize: 10, fontWeight: 700, letterSpacing: 1, textTransform: "uppercase", color: "#111", textDecoration: "none", border: "2px solid #111", padding: "10px 18px", display: "inline-block", background: "#F5C842", boxShadow: "5px 5px 0 #111" }}
                >
                  Book a session →
                </a>
              </div>
