import { renderTempoLabel } from './notes';
...
export default function PlayField({
  ...
  const completionText = showObstaclesUsed
    ...
    : 'You helped Laya reach the next locality.';
    ...
    <div className="sr-play-area" style={S.playArea}>
      <div className="sr-controls" style={S.controls}>
        {laneNames.map((name, laneIdx) => (
          ...
          >
            {renderTempoLabel(laneLabels[laneIdx])}
          </button>
        ))}
      </div>
      ...
      <div ref={fieldRef} className="sr-field" style={S.field} onPointerDown={moveToTappedLane}>
        ...
        <div style={S.svara} aria-label={`Laya in ${laneLabel} lane`}>
          <div style={S.wing} />
          <div style={S.beak} />
          <div style={S.eye} />
        </div>
            ...
            <p style={S.messageText}>
              {levelComplete
                ...
                : activeLevel.cueType === 'single-note'
                  ? 'Hear the tempo cue and choose its lane.'
                ...
                : activeLevel.cueType === 'two-note'
                  ...
                  : `The ${activeLevel.interval.toLowerCase()} tempo slide is your decision window: faster means top, slower means bottom.`}
            </p>
