...
export const GAME_MODES = [
  ...
  { id: 'bite', label: 'Bite', lives: 3, obstacleSpacingBars: 3, cueStartBeats: 8, color: colors.cream },
  { id: 'gobble', label: 'Gobble', lives: 2, obstacleSpacingBars: 3, cueStartBeats: 4, singleNoteCueStartBeats: 3, noteChangeBeats: 1, color: colors.red },
